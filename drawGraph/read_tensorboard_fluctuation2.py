...
fig, axes = plt.subplots(2, 4, figsize=(10.5, 4.5))
...
deft = myfpsDict['defaulttemp10'][0]
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %2 == 1:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-1:i+1]) / 2)
axes[0][2].plot(deft2, deft3, color = "C6")
...
deft = myfpsDict['defaulttemp30'][0]
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %2 == 1:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-1:i+1]) / 2)
axes[0][2].plot(deft2, deft3, color = "C8")
axes[0][2].set_xlabel("Frame rates. (fps)")
axes[0][2].set_xticks([])
axes[0][2].set_ylim(19, 44)



deft = powerDict['defaulttemp10'][0]
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %2 == 1:
...
axes[0][3].plot(deft2, deft3, color = "C6")
...
for i in range(len(deft["step"])):
    if i %2 == 1:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-1:i+1]) / 2/ 1000)
axes[0][3].plot(deft2, deft3, color = "C7")
axes[0][3].set_xticks([])

deft = powerDict['defaulttemp30'][0]
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %2 == 1:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-1:i+1]) / 2/ 1000)
axes[0][3].plot(deft2, deft3, color = "C8")
axes[0][3].set_xlabel("Power cons. (W)")
axes[0][3].set_xticks([])
# axes[0][3].set_ylim(64.15, 78.25)
...
for i in range(len(deft["step"])):
    if i %2 == 1:
        ...
        deft3.append(sum(deft["value"][i-1:i+1]) / 2)
axes[0][1].plot(deft2, deft3, color = "C8")
axes[0][1].set_xlabel("Total cool. states (#)")
axes[0][1].set_xticks([])
axes[0][1].set_ylim(-1, 35)
axes[0][1].set_yticks([0, 15, 30])
...
for i in range(len(deft["step"])):
    if i %2 == 1:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-1:i+1]) / 2)
axes[1][3].plot(deft2, deft3, color = "C6")
...
for i in range(len(deft["step"])):
    if i %2 == 1:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-1:i+1]) / 2)
axes[1][3].plot(deft2, deft3, color = "C7")
axes[1][3].set_xticks([])
...
for i in range(len(deft["step"])):
    if i %2 == 1:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-1:i+1]) / 2)
axes[1][3].plot(deft2, deft3, color = "C8")
axes[1][3].set_xlabel("GPU temp. (°C)")
axes[1][3].set_xticks([])
...
axes[0][3].grid(axis='y',linestyle='--')  
...
# fig.legend(["Default", "Limit"], loc='upper center', ncol=2, bbox_to_anchor=(0.5, 1.035),frameon=False, borderpad=0.1, fontsize=22)
fig.legend(["10°C", "20°C", "30°C"], loc='upper center', ncol=3, bbox_to_anchor=(0.5, 1.03), frameon=False, fontsize=18)
plt.tight_layout(pad = 0.1, rect = (0,0,1,0.92))
