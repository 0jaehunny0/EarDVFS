...
for exp in expLi:
    ...
    values3 = [
        [tempDict2["FStrain1120.0"][0].mean(), tempDict2["FStrain1130.0"][0].mean(), tempDict2["FStrain1140.0"][0].mean()],  # Group 1
        [tempDict2["Ablation220.0"][0].mean(), tempDict2["Ablation230.0"][0].mean(), tempDict2["Ablation240.0"][0].mean()],  # Group 1
        [tempDict2["Ablation320.0"][0].mean(), tempDict2["Ablation330.0"][0].mean(), tempDict2["Ablation340.0"][0].mean()],  # Group 1
        [tempDict2["blation4320.0"][0].mean(), tempDict2["blation4330.0"][0].mean(), tempDict2["blation4340.0"][0].mean()],  # Group 1
    ]
    values4 = [
        [tempDict3["FStrain1120.0"][0].mean(), tempDict3["FStrain1130.0"][0].mean(), tempDict3["FStrain1140.0"][0].mean()],  # Group 1
        [tempDict3["Ablation220.0"][0].mean(), tempDict3["Ablation230.0"][0].mean(), tempDict3["Ablation240.0"][0].mean()],  # Group 1
        [tempDict3["Ablation320.0"][0].mean(), tempDict3["Ablation330.0"][0].mean(), tempDict3["Ablation340.0"][0].mean()],  # Group 1
        [tempDict3["blation4320.0"][0].mean(), tempDict3["blation4330.0"][0].mean(), tempDict3["blation4340.0"][0].mean()],  # Group 1
    ]
...
for i in range(len(deft["step"])):
    if i %4 == 3:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-3:i+1]) / 4)
first = np.where(np.array(deft2) < 600)[0][0]
deft2 = deft2[first:]
deft3 = deft3[first:]
axes[0][0].plot(deft2, deft3, color = cmap(12))
