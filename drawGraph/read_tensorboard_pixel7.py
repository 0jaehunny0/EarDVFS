...
for exp in expLi:
    ...
    values1 = [
        [myfpsDict["p7z20.0"][0].mean(), myfpsDict["p7z30.0"][0].mean(), myfpsDict["p7z39.5"][0].mean()],  # Group 1
        [myfpsDict["p7g20.0"][0].mean(), myfpsDict["p7g30.0"][0].mean(), myfpsDict["p7g39.5"][0].mean()],  # Group 1
        [myfpsDict["p7D20.0"][0].mean(), myfpsDict["p7D30.0"][0].mean(), myfpsDict["p7D39.5"][0].mean()],  # Group 1
    ]
    values2 = [
        [mydict["p7z20.0"][0].mean(), mydict["p7z30.0"][0].mean(), mydict["p7z39.5"][0].mean()],  # Group 1
        [mydict["p7g20.0"][0].mean(), mydict["p7g30.0"][0].mean(), mydict["p7g39.5"][0].mean()],  # Group 1
        [mydict["p7D20.0"][0].mean(), mydict["p7D30.0"][0].mean(), mydict["p7D39.5"][0].mean()],  # Group 1
    ]
    values3 = [
        [tempDict2["p7z20.0"][0].mean(), tempDict2["p7z30.0"][0].mean(), tempDict2["p7z39.5"][0].mean()],  # Group 1
        [tempDict2["p7g20.0"][0].mean(), tempDict2["p7g30.0"][0].mean(), tempDict2["p7g39.5"][0].mean()],  # Group 1
        [tempDict2["p7D20.0"][0].mean(), tempDict2["p7D30.0"][0].mean(), tempDict2["p7D39.5"][0].mean()],  # Group 1
    ]
    values4 = [
        [tempDict3["p7z20.0"][0].mean(), tempDict3["p7z30.0"][0].mean(), tempDict3["p7z39.5"][0].mean()],  # Group 1
        [tempDict3["p7g20.0"][0].mean(), tempDict3["p7g30.0"][0].mean(), tempDict3["p7g39.5"][0].mean()],  # Group 1
        [tempDict3["p7D20.0"][0].mean(), tempDict3["p7D30.0"][0].mean(), tempDict3["p7D39.5"][0].mean()],  # Group 1
    ]
    ...
    v1 = np.array([myfpsDict["p7d20.0"][0].mean(), myfpsDict["p7d30.0"][0].mean(), myfpsDict["p7d39.5"][0].mean()])
    v2 = np.array([mydict["p7d20.0"][0].mean(), mydict["p7d30.0"][0].mean(), mydict["p7d39.5"][0].mean()])
    v3 = np.array([tempDict2["p7d20.0"][0].mean(), tempDict2["p7d30.0"][0].mean(), tempDict2["p7d39.5"][0].mean()])
    v4 = np.array([tempDict3["p7d20.0"][0].mean(), tempDict3["p7d30.0"][0].mean(), tempDict3["p7d39.5"][0].mean()])
...
ax[0].set_xlabel("PPW change (%)")
ax[0].legend(loc = "upper left", borderpad = 0.25, labelspacing=0.2, borderaxespad=0.25, handletextpad=0.4, handlelength=0.5)
...
ax[1].set_xlabel("Frame rate change (%)")
...
ax[2].set_xlabel("Processor temp. chg. (%)")
...
ax[3].set_xlabel("Total cool. states diff. (#)")
...
plt.tight_layout(pad=0.1)
lab, lab2 = ax[1].get_yticklabels(), []
for i in lab:
    if i._y > 0: lab2.append("+"+str(int(i._y)))
    else: lab2.append(str(int(i._y)))
ax[1].set_yticklabels(lab2)
...
for i in range(num_groups):
    ax[0][0].bar(x_positions + i * bar_width, [row[i] for row in valuesLi2[0]], 
            width=bar_width, label=labelLi[i], color = cmap(4 + i*4), alpha = 0.95)
ax[0][0].set_xticks(x_positions + bar_width)
ax[0][0].set_xticklabels(categories) 
ax[0][0].set_xlabel("PPW change (%)")
ax[0][0].legend(loc = "upper right", borderpad = 0.3, labelspacing=0.2, borderaxespad=0.3, handletextpad=0.4, handlelength=0.5)
ax[0][0].grid(axis='y',linestyle='--')  # Add grid to the second subplot
ax[0][0].set_axisbelow(True)



for i in range(num_groups):
    ax[0][1].bar(x_positions + i * bar_width, [row[i] for row in valuesLi1[0]], 
            width=bar_width, label=labelLi[i], color = cmap(4 + i*4), alpha = 0.95)
ax[0][1].set_xticks(x_positions + bar_width)
ax[0][1].set_xticklabels(categories) 
ax[0][1].set_xlabel("Frame rate change (%)")
# ax[0][1].legend(loc = "upper right", borderpad = 0.3, labelspacing=0.2, borderaxespad=0.3, handletextpad=0.4, handlelength=0.5)
ax[0][1].grid(axis='y',linestyle='--')  # Add grid to the second subplot
ax[0][1].set_axisbelow(True)


for i in range(num_groups):
    ax[1][0].bar(x_positions + i * bar_width, [row[i] for row in valuesLi3[0]], 
            width=bar_width, label=labelLi[i], color = cmap(4 + i*4), alpha = 0.95)
ax[1][0].set_xticks(x_positions + bar_width)
ax[1][0].set_xticklabels(categories) 
ax[1][0].set_xlabel("Processor temp. change (%)")
# ax[1][0].legend(loc = "upper right", borderpad = 0.3, labelspacing=0.2, borderaxespad=0.3, handletextpad=0.4, handlelength=0.5)
ax[1][0].grid(axis='y',linestyle='--')  # Add grid to the second subplot
ax[1][0].set_axisbelow(True)


for i in range(num_groups):
    ax[1][1].bar(x_positions + i * bar_width, [row[i] for row in valuesLi4[0]], 
            width=bar_width, label=labelLi[i], color = cmap(4 + i*4), alpha = 0.95)
ax[1][1].set_xticks(x_positions + bar_width)
ax[1][1].set_xticklabels(categories) 
ax[1][1].set_xlabel("Total cool. states diff. (#)")
# ax[1][1].legend(loc = "upper right", borderpad = 0.3, labelspacing=0.2, borderaxespad=0.3, handletextpad=0.4, handlelength=0.5)
ax[1][1].grid(axis='y',linestyle='--')  # Add grid to the second subplot
ax[1][1].set_axisbelow(True)

plt.tight_layout(pad=0.1)
lab, lab2 = ax[0][0].get_yticklabels(), []
for i in lab:
    if i._y > 0: lab2.append("+"+str(int(i._y)))
    else: lab2.append(str(int(i._y)))
ax[0][0].set_yticklabels(lab2)
...
ax[1].grid(axis='y',linestyle='--')  # Add grid to the second subplot
ax[1].set_axisbelow(True)
# ax[1].set_xlabel("App 1")
ax[1].legend(loc = "upper left", borderpad = 0.3, labelspacing=0.2, borderaxespad=0.3, handletextpad=0.4, handlelength=0.5)
