...
for subdir, dirs, files in os.walk("selected/iccadFluctuation"):
    a = subdir.split("/")
...
1 - mydict['gearDVFStargetUtil0.0'][0]["value"].mean() / mydict['defaulttemp20'][0]["value"].mean()
1 - myfpsDict['gearDVFStargetUtil0.0'][0]["value"].mean() / myfpsDict['defaulttemp20'][0]["value"].mean()
...
# ax1.axvline(600, color='black', linewidth=2)
...
axes[0][1].set_xticks([])
axes[0][1].set_yticks([1.5, 2.0, 2.5, 3.0])
