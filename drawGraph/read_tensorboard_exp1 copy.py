...
expLi = ["iccadExp1", "exp2", "exp4", "exp5"]
...
(valuesLi3[0][:, 2].mean() + valuesLi3[1][:, 2].mean() + valuesLi3[2][:, 2].mean() + valuesLi3[3][:, 2].mean()) / 4
(valuesLi4[0][:, 2].mean() + valuesLi4[1][:, 2].mean() + valuesLi4[2][:, 2].mean() + valuesLi4[3][:, 2].mean()) / 4


(valuesLi3[0][:, 0].mean() + valuesLi3[1][:, 0].mean() + valuesLi3[2][:, 0].mean() + valuesLi3[3][:, 0].mean()) / 4
(valuesLi3[0][:, 1].mean() + valuesLi3[1][:, 1].mean() + valuesLi3[2][:, 1].mean() + valuesLi3[3][:, 1].mean()) / 4


valuesLi1[0][0, 2] + valuesLi1[1][0, 2] + + valuesLi1[1][2, 2] +  sum(valuesLi1[3][:, 2])
