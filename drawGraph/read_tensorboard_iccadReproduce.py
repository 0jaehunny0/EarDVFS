...
for subdir, dirs, files in os.walk("selected/iccadReproduce"):
...
#         return 0.0  # 벡터가 0이면 유사도 정의 불가 (혹은 예외처리)
...
for i in range(len(deft["step"])):
    if i %4 == 3:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-3:i+1]) / 4)
axes[0][0].plot(deft2, deft3, color = "C9", linestyle="--")
axes[0][0].set_xticks([])
axes[0][0].set_xlabel("App 1 / Deft / 20°C")
znccLi.append(zncc(xx, deft2))
...
for i in range(len(deft["step"])):
    if i %4 == 3:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-3:i+1]) / 4)
axes[0][1].plot(deft2, deft3, color = "C9", linestyle="--")
axes[0][1].set_xticks([])
axes[0][1].set_xlabel("App 2 / zTT / 20°C")
znccLi.append(zncc(xx[:-1], deft2))
...
for i in range(len(deft["step"])):
    if i %4 == 3:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-3:i+1]) / 4)
axes[0][2].plot(deft2, deft3, color = "C7")

deft = myfpsDict['gearDVFStargetUtil0.0'][1]
xx = deft2
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %4 == 3:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-3:i+1]) / 4)
axes[0][2].plot(deft2, deft3, color = "C9", linestyle="--")
axes[0][2].set_xticks([])
axes[0][2].set_xlabel("App 3 / Gear / 30°C")
znccLi.append(zncc(xx, deft2[:-2]))




deft = myfpsDict['p7defaulttemp10'][0]
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %4 == 3:
...
deft = myfpsDict['p7defaulttemp10'][1]
xx = deft2
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %4 == 3:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-3:i+1]) / 4)
axes[1][0].plot(deft2, deft3, color = "C9", linestyle="--")
axes[1][0].set_xticks([])
axes[1][0].set_xlabel("App 1 / Deft / 10°C / Pixel 7")
znccLi.append(zncc(xx, deft2))
...
deft = myfpsDict['DVFStrain11temp20'][1]
xx = deft2
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %4 == 3:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-3:i+1]) / 4)
axes[1][1].plot(deft2, deft3, color = "C9", linestyle="--")
axes[1][1].set_xticks([])
axes[1][1].set_xlabel("App 3 / Ear / 20°C")
znccLi.append(zncc(xx, deft2))


deft = myfpsDict['DVFStrain11tempx2'][0]
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %4 == 3:
...
deft = myfpsDict['DVFStrain11tempx2'][1]
xx = deft2
deft2, deft3 = [], []
firstTime = deft["wall_time"][0]
for i in range(len(deft["step"])):
    if i %4 == 3:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-3:i+1]) / 4)
axes[1][2].plot(deft2, deft3, color = "C9", linestyle="--")
axes[1][2].set_xticks([])
axes[1][2].set_xlabel("App 4 / Ear / 20°C")
znccLi.append(zncc(xx, deft2))
...
for i in range(len(deft["step"])):
    if i %8 == 7:
        deft2.append(deft["wall_time"][i] - firstTime)
        deft3.append(sum(deft["value"][i-7:i+1]) / 8)
...
fig.legend(["10°C", "20°C", "30°C"], loc='upper right', ncol=1, bbox_to_anchor=(0.95, 1),frameon=True, fontsize=16)
plt.tight_layout(pad = 0.1, rect = (0,0,1,1))
