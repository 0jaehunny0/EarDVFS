...
mid_available_frequencies = np.array(mid_available_frequencies)[[int(np.round(15*2/8))-1, int(np.round(15*5/8))-1, int(np.round(15*8/8))-1]]
big_available_frequencies = np.array(big_available_frequencies)[[int(np.round(16*2/8))-1, int(np.round(16*5/8))-1, int(np.round(16*8/8))-1]]
gpu_available_frequencies = np.array(gpu_available_frequencies)[[int(np.round(11*1/4))-1, int(np.round(11*2/4))-1, int(np.round(11*3/4))-1]]
