...
run_name = f"{int(time.time())}__p7default__{args.tempSet}__exp{args.experiment}__temp{args.temperature}"
...
c_states, temps, qos, t1a, t2a, littlea, mida, biga, gpua, a, gpu_util, freqs, _, _, _ = get_states2(window, "fps", None, None, None)
