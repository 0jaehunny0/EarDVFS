...
class DVFStrain(Env):
    def __init__(self, initSleep, experiment, qos_type: str):
        ...
        self.action_space = spaces.MultiDiscrete([11, 15, 16, 11])
        ...
        reward = cal_reward(qos, little, mid, big, gpu, [11, 15, 16, 11], c_states)

        states = np.concatenate([[reward, fps, power, ppw], temps, freqs/30000, [little, mid, big, gpu], [little_u, mid_u, big_u], [gpu_util[0]*100], c_states, [11, 15, 16, 11]])
    ...
    def step(self, action):
        ...
        up, down, gpu_rate = 5000, 5000, 50 #50
