...
def cal_reward(qos: float, little, mid, big, gpu, action, c_states):
    ...
    a,b,c,d = temperatures[0], temperatures[1], temperatures[2], temperatures[3]
    ...
    reward = qos * (1 + c_state_reward) + temp_reward
...
class DVFStrain(Env):
    def __init__(self, initSleep, experiment, qos_type: str):
        ...
        reward = cal_reward(qos, temps, mid, big, gpu, [11, 14, 17, 12], c_states)
    ...
    def step(self, action):
        ...
        reward = cal_reward(qos, temps, mid, big, gpu, action, c_states)
